...
if (typeof prStatus.summary?.total_non_default_branches !== "number") fail("pr-status.json missing branch aggregate");
if (typeof prStatus.summary?.branches_without_open_pr !== "number") fail("pr-status.json missing orphan branch aggregate");
