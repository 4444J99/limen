...
for (const name of ["tasks.json", "client-status.json", "internal-status.json", "qa-status.json", "owner-surface-manifest.json", "client-surface-manifest.json", "readiness.json"]) {
...
for (const surface of ["internal", "client", "public", "qa"]) {
...
if (JSON.stringify(ownerManifestIds) !== JSON.stringify(["client", "internal", "public", "qa"])) fail("owner manifest missing sanctioned surfaces");
...
if (clientSurfaceManifest.contracts.internal || clientSurfaceManifest.contracts.qa || clientSurfaceManifest.contracts.readiness) fail("client manifest exposes owner contracts");
if (publicSurfaceManifest.contracts.internal || publicSurfaceManifest.contracts.qa || publicSurfaceManifest.contracts.client) fail("public manifest exposes non-public contracts");
if (surfaceManifest.contracts.internal || surfaceManifest.contracts.qa || surfaceManifest.contracts.client) fail("default manifest exposes non-public contracts");
