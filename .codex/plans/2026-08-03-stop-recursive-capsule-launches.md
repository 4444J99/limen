...
- Validate the linked worktree Git directory, common Git directory, and configured remote before
  conduct or runway admission. Keep the remote probe and fetch bounded and diagnose permission or
  network failures as launch-environment errors.
...
remote. The repository's scoped verifier must pass for the exact implementation head.
