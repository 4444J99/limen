...
Paragraphs are single-thought clusters. Give one long sentence its own paragraph; keep two short sentences together only when the second directly completes the first. A new qualification, comparison, drawback, or verdict begins a new paragraph.
