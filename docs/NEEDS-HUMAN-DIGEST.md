...
**RESOLVED 2026-08-14:** stale — no human action owed. The billing root cleared 2026-07-17 (L-CARD-FRAUD-HOLD discharge: payment canary green, $25 Actions budget set by machine), issue organvm/hospes#3 closed 2026-07-22 via merged PR organvm/hospes#8, and CI has run green on `ubuntu-latest` since (10/10 most-recent runs green as of 2026-08-13, CI + CodeQL). Verified live via `gh run list -R organvm/hospes` during the 2026-08-14 hospes campaign (limen #2401).
